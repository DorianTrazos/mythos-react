...
const BIRTH = {
	...
	contentTitle: 'THE BIRTH OF ANUBIS',
	images: {
...
export const EGYPTIAN_INFO = [
	{
		id: v4(),
		tabTitle: 'GODS',
		subTabs: [RA, ANUBIS, HORUS]
	},
	{
		id: v4(),
		tabTitle: 'CREATURES',
		subTabs: [AMMIT, BENNU, SERPOPARD]
	},
	{
		id: v4(),
		tabTitle: 'MYTHS',
		subTabs: [TEARS, BIRTH, STEAL]
	}
];
