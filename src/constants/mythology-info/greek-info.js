...
const ICARUS = {
	...
	contentTitle: 'ICARUS AND DEDALUS',
	images: {
...
const ORPHEUS = {
	...
	contentTitle: 'ORPHEUS AND EURYDICE',
	images: {
...
const PERSEUS = {
	...
	contentTitle: 'PERSEUS AND MEDUSA',
	images: {
