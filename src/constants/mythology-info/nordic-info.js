...
const RAGNAROK = {
	...
	text: 'Ragnarök, the end of the world in Norse mythology, is the apocalyptic battle where gods, giants, and creatures clash in a cosmic struggle. Fenrir kills Odin, Thor faces Jörmungandr, and Surtr engulfs the world in flames. This chaotic event signifies the destruction of the old order, but also the promise of renewal as a new world emerges. Ragnarök encapsulates themes of destiny, cyclical time, and the inevitable balance between creation and destruction in Norse belief.'
};
...
export const NORDIC_INFO = [
	{
		id: v4(),
		tabTitle: 'GODS',
		subTabs: [ODIN, THOR, LOKI]
	},
	{
		id: v4(),
		tabTitle: 'CREATURES',
		subTabs: [FENRIR, JÖRGUNMANDR, NIDHÖGGR]
	},
	{
		id: v4(),
		tabTitle: 'MYTHS',
		subTabs: [MJOLNIR, RAGNAROK, SKÖLL]
	}
];
